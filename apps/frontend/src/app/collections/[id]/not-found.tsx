...
export default function CollectionNotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6 px-4 text-center">
      ...
      <h2 className="text-2xl font-semibold text-amber-800">Collection not found</h2>
      <p className="max-w-md text-amber-700">This collection does not exist, has been deleted, or is not accessible.</p>
      <Link
        href="/collections"
