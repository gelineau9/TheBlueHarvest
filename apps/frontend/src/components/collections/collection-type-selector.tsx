...
const collectionTypes: CollectionType[] = [
  {
    ...
    name: 'collection',
    label: 'Collection',
    description: 'A general collection that may house any type of post',
    icon: FolderOpen,
  },
  {
    id: 2,
    name: 'chronicle',
    label: 'Chronicle',
    description: 'A collection that houses Writing posts that share a narrative',
    icon: BookOpen,
  },
  {
    id: 3,
    name: 'album',
    label: 'Album',
    description: 'A collection that houses Media posts',
    icon: Image,
  },
  {
    id: 4,
    name: 'gallery',
    label: 'Gallery',
    description: 'A collection that houses Art posts',
    icon: Palette,
  },
  {
    id: 5,
    name: 'event-series',
    label: 'Event Series',
    description: 'A collection that houses related Event posts',
    icon: Calendar,
  },
];
