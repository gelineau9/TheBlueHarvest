...
// NOTE: POST /:id/posts and DELETE /:id/posts/:postId routes are handled by collectionPosts.ts
// to avoid duplication. That router provides add, remove, and reorder functionality.
