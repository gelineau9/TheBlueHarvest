...
import { LogOut, Settings, User, PlusCircle, Shield, KeyRound } from 'lucide-react';
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="relative h-20 w-20 rounded-full bg-amber-50/30 backdrop-blur-sm hover:bg-amber-50/50 cursor-pointer"
        >
          <Avatar className="h-20 w-20 border-2 border-amber-800/30">
            {isLoading ? (
          ...
          <>
            ...
            <DropdownMenuItem asChild className="text-amber-900 hover:bg-amber-100">
              <Link href="/change-password">
                <KeyRound className="mr-2 h-4 w-4 text-amber-700" />
