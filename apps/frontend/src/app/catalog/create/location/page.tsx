      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold text-amber-900">Create Location Profile</h1>
          </div>
          <p className="text-lg text-amber-700">Document a location in Middle-earth</p>
        </div>

        <div className="bg-white rounded-lg border border-amber-300 p-8 shadow-sm">
          <ProfileForm profileTypeId={5} onSuccess={handleSuccess} onCancel={handleCancel} />
        </div>
      </div>
    </div>
  );
